XA.component.search.facet.resultsfilter = (function ($, document) {
    ...
    var FacetResultsFilterModel = Backbone.Model.extend({
        defaults: {
            template: "<div class='facet-search-filter'><% " +
                            "_.forEach(facet.Values, function(value){" +
                                "%><p class='facet-value' data-facetValue='<%= value.Name !== '' ? value.Name : '_empty_' %>'>" +
    ...
    var FacetResultsFilterView = XA.component.search.baseView.extend({
        ...
        setActiveFacet: function(facetGroupName, facetValueName) {
            ...
            facetValueName = facetValueName.toLowerCase();
            facetValue = this.$el.find("[data-facetvalue='" + facetValueName + "']");
